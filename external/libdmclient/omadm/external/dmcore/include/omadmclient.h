 ...
 * @file omadmclient.h
 *
 * @brief Interface to the libdmclient library.
 *
 ******************************************************************************/
...
/*!
 * @brief Add an alert to the packet to be sent to the server
 *
 * @param sessionH session handle
 * @param alert_code Alert code.
 *                   Code 1223 - Session Abort Alert
 *                   Code 1222 - More Messages Alert
 * @returns DMCLT_ERR_NONE if successful or one of DMCLT_ERR_*
 */
