...
PRODUCT_PACKAGES += WifiNvService
PRODUCT_PACKAGES += Otademo
...
PRODUCT_COPY_FILES += \
    ...
    device/qcom/msm8909/WCNSS_qcom_wlan_nv_a_au_eu.bin:system/etc/wifi/WCNSS_qcom_wlan_nv_a_au_eu.bin \
    device/qcom/msm8909/WCNSS_qcom_wlan_nv_cepd_pf.bin:system/etc/wifi/WCNSS_qcom_wlan_nv_cepd_pf.bin \
    device/qcom/msm8909/WCNSS_qcom_wlan_nv_ce_cepb_pc_pe_wsa.bin:system/etc/wifi/WCNSS_qcom_wlan_nv_ce_cepb_pc_pe_wsa.bin \
    device/qcom/msm8909/WCNSS_qcom_wlan_nv_e_j_wsc.bin:system/etc/wifi/WCNSS_qcom_wlan_nv_e_j_wsc.bin \
    device/qcom/msm8909/WCNSS_qcom_wlan_nv_cepi_pj.bin:system/etc/wifi/WCNSS_qcom_wlan_nv_cepi_pj.bin \
    device/qcom/msm8909/persist_nv:system/etc/wifi/persist_nv
...
PRODUCT_COPY_FILES += vendor/verizon/dmclient/init/dmacc-init.txt:/system/vendor/verizon/dmclient/init/dmacc-init.txt

PRODUCT_MANUFACTURER := Quectel
...
PRODUCT_COPY_FILES += vendor/verizon/dmclient/platform/cacert/ca-bundle.crt:/system/etc/security/cacerts/ca-bundle.crt \
       vendor/verizon/dmacc-init.txt:system/vendor/verizon/dmclient/init/dmacc-init.txt
