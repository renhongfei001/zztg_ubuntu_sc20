...
$(shell mkdir -p $(PRODUCT_OUT)/system/vendor/verizon)

$(shell mkdir -p $(PRODUCT_OUT)/system/vendor/verizon/dmclient)

$(shell mkdir -p $(PRODUCT_OUT)/system/vendor/verizon/dmclient/init)

$(shell mkdir -p $(PRODUCT_OUT)/system/vendor/verizon/dmclient/lib)
...
include device/qcom/msm8909/WifiNvservice/Android.mk
#----------------------------------------------------------------------
