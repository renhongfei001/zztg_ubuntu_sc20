...
public class DcTracker extends Handler {
    ...
    private int mAlarmReconnect = 0;
    private String mAlarmReconnectUri="Toggle_Reconnect_Apn";
    ...
    public DcTracker(Phone phone) {
        ...
        registerSettingsObserver();
        mAlarmReconnect=Settings.Global.getInt(mPhone.getContext().getContentResolver(), mAlarmReconnectUri,1);
    }
    ...
    private void onDisconnectDone(AsyncResult ar) {
        ...
        if (mAttached.get() && apnContext.isReady() && retryAfterDisconnected(apnContext)) {
            ...
            if (delay > 0 && (mAlarmReconnect == 1)) {
                ...
                startAlarmForReconnect(delay, apnContext);
                 if (DBG) log("startAlarmForReconnect");
            }
        } else {
    ...
    void onRecordsLoaded() {
        ...
        Settings.Global.putInt(mPhone.getContext().getContentResolver(),
                    "current_slot_sub_id" + phoneId,
                    subId);
        log("onRecordsLoaded set  phoneId= "+phoneId
              +" subId= "+subId);
        if (mSubscriptionManager.isActiveSubId(subId)) {
            onRecordsLoadedOrSubIdChanged();
        } else {
