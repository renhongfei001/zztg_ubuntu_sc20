...
public class MobileSignalController extends SignalController<
    ...
    private boolean showIcon4Certification =false;
    ...
    public MobileSignalController(Context context, Config config, boolean hasMobileData,
        ...
        super("MobileSignalController(" + info.getSubscriptionId() + ")", context,
                ...
                networkController);
        showIcon4Certification = SystemProperties.get("gsm.version.baseband", "null").contains("SC20A")
    ...
    public void notifyListeners(SignalCallback callback) {
        ...
        showDataIcon &= (mStyle == STATUS_BAR_STYLE_ANDROID_DEFAULT
         ...
         if(!showIcon4Certification){
            typeIcon = showDataIcon ? icons.mDataType : 0;
            }
    ...
    private void generateIconGroup() {
        ...
        int chosenNetworkType = ((dataType == TelephonyManager.NETWORK_TYPE_UNKNOWN)
                ? voiceType : dataType);
        if(showIcon4Certification){
        TelephonyIcons.updateDataTypeForVerizon(slotId, chosenNetworkType, mConfig.showAtLeast3G,
                mConfig.show4gForLte, mConfig.hspaDataDistinguishable, inet,
                mCurrentState,showDataIcon);
        }else{
