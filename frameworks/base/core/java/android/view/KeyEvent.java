...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_CAM = 284;
    public static final int KEYCODE_SOS = 285;
    public static final int KEYCODE_ZZ_AU = 286;
    public static final int KEYCODE_LASER = 287;

    // private static final int LAST_KEYCODE = KEYCODE_SYSTEM_NAVIGATION_RIGHT;

    private static final int LAST_KEYCODE = KEYCODE_LASER;
    ...
    public static final boolean isSystemKey(int keyCode) {
	    ...
	    case KeyEvent.KEYCODE_CAM:
            case KeyEvent.KEYCODE_SOS:
	    case KeyEvent.KEYCODE_ZZ_AU:
	    case KeyEvent.KEYCODE_LASER:
                return true;
        }
