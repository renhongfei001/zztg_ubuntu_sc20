...
abstract class TelephonyConnection extends Connection {
    ...
    private int mRegisterSuppService = 1;
    private String mRegisterSuppServiceUri = "Toggle_Register_SuppService";
    ...
    void setOriginalConnection(com.android.internal.telephony.Connection originalConnection) {
        ...
        mRegisterSuppService = Settings.Global.getInt(getPhone().getContext().getContentResolver(), mRegisterSuppServiceUri,0);
        if(mRegisterSuppService==1){
            getPhone().registerForSuppServiceNotification(mHandler, MSG_SUPP_SERVICE_NOTIFY, null);
             Log.v(this,"registerForSuppServiceNotification");
        }
        ...
        if (mOriginalConnection != null) {
            if (getPhone() != null) {
                ...
                if(mRegisterSuppService==1){
                    ...
                    Log.v(this,"unregisterForSuppServiceNotification");
                }
