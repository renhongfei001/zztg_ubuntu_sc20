...
public class CallAudioManager extends CallsManagerListenerBase {
    ...
    private void playToneForDisconnectedCall(Call call) {
        Log.v(this, "klein:mForegroundCall = " + mForegroundCall + ", call = " + call + ", mCalls.size() = " + mCalls.size());
        Log.v(this, "always play tone when alwaysplaytone is true");
        boolean alwaysplaytone = true;
        if (!alwaysplaytone && mForegroundCall != null && call != mForegroundCall && mCalls.size() > 1) {
