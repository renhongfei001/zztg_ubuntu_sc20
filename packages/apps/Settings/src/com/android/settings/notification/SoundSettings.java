...
public class SoundSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private void initRingtones() {
        ...
        /*Conway 2019-04-09: remvoe the alarm ringtone preference start*/
        //because user can set ringtone of alarm in DesckClock, and it is nothing when user
        //change the alarm ringtnoe in Settings.
        if (mAlarmRingtonePreference != null) {
            getPreferenceScreen().removePreference(mAlarmRingtonePreference);
        }
        /*Conway 2019-04-09: remvoe the ringtone preference end*/
    }
