...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setStringSummary(KEY_FIRMWARE_VERSION, Build.VERSION.RELEASE + getQuectelVerion());
   ...
   /*
    * get ro.build.quectelversion.release
    * andrew.hu add
    */
    private String getQuectelVerion(){
        String quectelVersion = SystemProperties.get("ro.build.quectelversion.release");
        if(quectelVersion != null && quectelVersion.contains("V")){
            String str = quectelVersion.split("V")[0];
            return "." + str;
        }
        return "";
    }
